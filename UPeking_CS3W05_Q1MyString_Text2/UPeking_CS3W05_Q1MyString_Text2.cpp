...
/**
 ...
 Requirement: MyString must be derived from C++ standard string. Suggestion 1: As a result, the "string" replacement for
 "MyString" in the beginning of the process, the purpose of the procedure was removed after the end of the second sentence, 
 ...
 type function is only filled in at the top of the last two sentences. Suggestion 2: string type has one component function 
